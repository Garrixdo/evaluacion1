...
salida.innerHTML += `<br>Placa ${vehiculo1.placa}: Tipo ${
  vehiculo1.tipo
}: Tarifa Bs.${vehiculo1.tarifa()}`;
salida.innerHTML += `<br>Placa ${vehiculo2.placa}: Tipo ${
  vehiculo2.tipo
}: Tarifa Bs.${vehiculo2.tarifa()}`;
salida.innerHTML += `<br>Placa ${vehiculo3.placa}: Tipo ${
  vehiculo3.tipo
}: Tarifa Bs.${vehiculo3.tarifa()}`;
salida.innerHTML += `<br>Placa ${vehiculo4.placa}: Tipo ${
  vehiculo4.tipo
}: Tarifa Bs.${vehiculo4.tarifa()}`;
salida.innerHTML += `<br>Placa ${vehiculo5.placa}: Tipo ${
  vehiculo5.tipo
}: Tarifa Bs.${vehiculo5.tarifa()}`;
salida.innerHTML += "<br>";
